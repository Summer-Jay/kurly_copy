	...
	<table border = "1" style="border-collapse:collapse;">
		...
		<tr height="40">
			<td align="center" colspan="4">
				...
				<input type="button" value="답글쓰기" onclick="location.href='${cp}/writeAnswer.do?num=${bean.getNum()}'">
				<input type="button" value="목록보기" onclick="location.href='${cp}/adminShowBoardList.do'" >
			</td>
		</tr>
	</table>
</div>
